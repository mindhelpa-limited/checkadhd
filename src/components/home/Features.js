...
export default function Features() {
  ...
  return (
    <section className="bg-[radial-gradient(ellipse_at_top,_#0a122a_0%,_#05080f_100%)] py-28 sm:py-36 text-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 space-y-32">
        {/* Section Header */}
        <div className="text-center max-w-3xl mx-auto animate-fade-in-up">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight tracking-tight font-serif text-white !text-white">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center animate-fade-in-up">
          <div>
            <h3 className="font-serif text-3xl font-bold text-white">Start with Understanding</h3>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center animate-fade-in-up">
          ...
          />
          <div>
            <h3 className="font-serif text-3xl font-bold text-white">Grow with Guidance</h3>
            <p className="mt-4 text-gray-300">
