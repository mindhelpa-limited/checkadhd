...
export default function Features() { const router = useRouter();

return ( <section className="bg-[#0a122a] py-28 sm:py-36 text-white"> <div className="max-w-7xl mx-auto px-6 lg:px-8 space-y-32">
