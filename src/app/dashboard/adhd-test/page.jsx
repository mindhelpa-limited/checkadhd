...
  ssr: false,
  loading: () => <div>Loading...</div>, // Optional: A simple loading placeholder
});
...
// --- helper to mirror your Report thresholds/text ---
...
    // The dynamic import ensures this code runs only on the client
    if (!html2pdf) return;
