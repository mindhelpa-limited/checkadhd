"use client";
 ...
 const RetakeTestModal = ({ timeLeft, onClose, onViewResults, playClickSound }) => (
   <div className="fixed inset-0 z-50 bg-gray-950 bg-opacity-80 flex items-center justify-center p-4">
     <div className="relative bg-gray-800/50 backdrop-blur-xl p-8 rounded-3xl shadow-2xl border border-gray-700 max-w-sm w-full animate-fade-in">
       <button
       ...
       <div className="text-center">
         <ClockIcon className="h-16 w-16 text-purple-400 mx-auto mb-4" />
         ...
         <div className="bg-gray-700/50 backdrop-blur-sm p-4 rounded-xl mb-4">
         ...
         <button
           ...
           className="w-full px-8 py-3 text-sm font-semibold text-white rounded-2xl bg-purple-500 hover:bg-purple-600 transition-colors"
         >
           View Current Result
         </button>
       </div>
 ...
 export default function DashboardPage() {
   ...
   return (
     <main className="relative min-h-screen p-6 md:p-10 text-gray-200 bg-gray-950 overflow-hidden">
       {/* Audio element for the click sound */}
       <audio ref={audioRef} src="/sounds/click.mp3" preload="auto" />
 
       {/* Enhanced animated background effect */}
       <div className="absolute top-0 left-0 w-full h-full z-0 pointer-events-none">
         <div className="absolute -top-1/4 -left-1/4 w-1/2 h-1/2 bg-purple-500 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob" />
         <div className="absolute -bottom-1/4 -right-1/4 w-1/2 h-1/2 bg-teal-500 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob-delay" />
       </div>
 
       <div className="relative max-w-6xl mx-auto z-10">
         <h1 className="text-4xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-purple-500 leading-tight">
         ...
         <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
           ...
           <div className="bg-gray-800/50 backdrop-blur-xl p-6 md:p-8 rounded-3xl shadow-2xl border border-gray-700 md:col-span-2 transition-all duration-300 transform hover:scale-[1.02] hover:shadow-2xl">
             <h2 className="text-xl md:text-2xl font-bold mb-6 flex items-center text-white">
               <SparklesIcon className="h-6 w-6 md:h-8 md:w-8 mr-3 flex-shrink-0 text-yellow-300 animate-shimmer" />
               Your Premium Account
             </h2>
             {userData && (
               <ul className="space-y-4 md:space-y-6">
                 <li className="flex items-center p-4 bg-gray-900/50 backdrop-blur-md rounded-xl transition-all duration-300 transform hover:scale-[1.02] hover:bg-gray-700/50 hover:shadow-lg">
                   <UserCircleIcon className="h-6 w-6 text-purple-400 mr-4 flex-shrink-0" />
                   <div>
                 ...
                 <li className="flex items-center p-4 bg-gray-900/50 backdrop-blur-md rounded-xl transition-all duration-300 transform hover:scale-[1.02] hover:bg-gray-700/50 hover:shadow-lg">
                   <TrophyIcon className="h-6 w-6 text-purple-400 mr-4 flex-shrink-0" />
                   <div>
                 ...
                 <li className="flex items-center p-4 bg-gray-900/50 backdrop-blur-md rounded-xl transition-all duration-300 transform hover:scale-[1.02] hover:bg-gray-700/50 hover:shadow-lg">
                   <CalendarDaysIcon className="h-6 w-6 text-purple-400 mr-4 flex-shrink-0" />
                   <div>
           ...
           <div className="bg-gray-800/50 backdrop-blur-xl p-6 md:p-8 rounded-3xl shadow-2xl border border-gray-700 flex flex-col justify-between transition-all duration-300 transform hover:scale-[1.02] hover:shadow-2xl">
             ...
             <div>
               <button
                 ...
                 className={`w-full px-8 py-4 text-lg font-semibold text-white rounded-2xl shadow-lg transition-all duration-300 transform focus:outline-none focus:ring-4 focus:ring-opacity-50
                   ${retakeAvailable
                     ? "bg-purple-600 hover:shadow-2xl hover:-translate-y-1 active:scale-95 focus:ring-purple-500"
                     : "bg-gray-700/50 text-gray-400 cursor-pointer hover:shadow-xl active:scale-95"
                   }`}
               >
