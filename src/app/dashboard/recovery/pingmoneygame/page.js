...
export default function PingMoneyGame() {
    ...
    const countdownInterval = setInterval(() => {
      setCountdown(prev => {
        ...
        if (nextCount > 0) {
          ...
          setCountdown(null);
          router.push('/dashboard/recovery/pingmoneygame/session');
          return null;
        }
      });
    }, 1000);
  ...
  return (
    <div className="min-h-screen text-white font-mono flex flex-col relative overflow-hidden font-orbitron selection:bg-cyan-500 selection:text-black" style={{ backgroundImage: `url('/images/neuralbounds.png')`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundAttachment: 'fixed' }}>
      ...
      <div className="flex flex-col items-center justify-center pt-32 pb-8 relative z-10 p-6">
        ...
        >
          <strong className="font-extrabold">PingPong</strong>
        </motion.h1>
        <motion.p
        ...
        >
          <strong className="font-extrabold">Rock your wealth</strong>
        </motion.p>
        <motion.div
