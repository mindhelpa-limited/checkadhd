...
export default function SuccessAdult() {
  ...
  return (
    <>
      <section
        ...
        bg-gradient-to-br from-[#020B1E] via-[#051B40] to-[#092D6F] 
      ...
      >
        ...
        >
          ...
          <p className="text-base sm:text-lg text-[#C9D2FF] leading-relaxed">
            Congratulations! You have successfully paid for the{" "}
            <span className="font-semibold text-white">One on One Clinical Adult ADHD Assessment</span> valued at{" "}
            <span className="font-semibold text-[#4EE1B6]">£1000</span>.
          </p>

          <p className="mt-5 text-[#C9D2FF] text-sm sm:text-base">
            We’ve sent you an email with further details, and our team will also
            contact you by phone shortly.
          </p>
