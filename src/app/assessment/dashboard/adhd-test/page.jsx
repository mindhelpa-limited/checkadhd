...
// import dynamic from 'next/dynamic'; // ❌ REMOVED: No longer needed for html2pdf.js
...
// ❌ REMOVED: No longer needed as we are using window.print()
...
    return { level: "High likelihood of ADHD traits", riskLevelText: "High Risk" };
  }
  if (scorePercentage >= 40) {
    return { level: "Moderate likelihood of ADHD traits", riskLevelText: "Moderate Risk" };
  }
...
  // const [isDownloading, setIsDownloading] = useState(false); // ❌ No longer needed
...
// ✅ FINAL FIX: Use the reliable native print function
const handleDownloadPDF = () => {
    // Calling the native print dialog on the window object
    window.print(); 
};
...
              >
                📄 Download / Print Detailed Report
              </button>
              <a
                href="/dashboard/adhd-history"
