    ...
    <div className="bg-white text-gray-800">
      ...
      <div className="py-24">
        <div className="max-w-4xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <span className="text-blue-600 font-semibold tracking-wider uppercase">OUR STORY</span>
            <h2 className="text-4xl font-bold mt-2 mb-4 text-gray-900">Born from a Need for Clarity</h2>
      ...
      <div className="bg-gray-50 py-24">
        <div className="max-w-7xl mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center mb-16">
                <h2 className="text-4xl font-extrabold text-gray-900 tracking-tight">Our Core Values</h2>
                <p className="mt-4 text-lg text-gray-600">These principles guide every decision we make and every feature we build.</p>
            </div>
